...
def generate_unified_regulatory_package(output_dir: str, custom_params: Optional[dict] = None) -> Dict[str, Any]:
    ...
    if "29" in str(v_datum):
        ...
        raise HTTPException(
            status_code=400, 
            detail="VERTICAL DATUM VIOLATION: NGVD 29 is not permitted for FEMA/IDNR submissions. Use the 'NCAT' tool in the System Dashboard to transform elevations to NAVD 88 using VERTCON 3.0."
        )
