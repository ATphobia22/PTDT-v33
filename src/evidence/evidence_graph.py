...
class ProvenanceRecord:
    ...
    def create(
        ...
        *,
        ...
        provenance_id = "prov-" + hashlib.sha256(canonical_json(seed).encode()).hexdigest()
        return cls(
...
class EvidenceGraph:
    """Read-only evidence graph used by renderers and inspectors.

    It records provenance and relationships but never calculates engineering values.
    Archimedes remains the independent calculation authority.
    """
    ...
    def manifest(self) -> Dict[str, Any]:
        ...
        body = {"records": records, "edges": edges}
