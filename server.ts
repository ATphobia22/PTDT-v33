...
Structure your response with clear headers and bullet points. End with "SYSTEM_SEAL: SHA256-VERIFIED-AI-OUTPUT".`;
  ...
  const ptdtLibrary = [
    ...
    {
      id: "doc_06_in_lidar",
      name: "Indiana_Statewide_LiDAR_2011_2013.pdf",
      size: "4.5 MB",
      type: "Topography Data",
      date: "2026-08-03"
    },
    {
      id: "doc_07_fema_links",
      name: "FEMA_GSA_DHS_Reference_Links.pdf",
      size: "1.2 MB",
      type: "Reference Documentation",
      date: "2026-08-03"
    },
    {
      id: "doc_08_nfip_toolkit",
      name: "National_Flood_Insurance_Program_Media_Toolkit.pdf",
      size: "3.4 MB",
      type: "FEMA Guide",
      date: "2026-08-03"
    },
    {
      id: "doc_09_noaa_paleo",
      name: "NOAA_Paleoclimatology_Goose_Pond.pdf",
      size: "845 KB",
      type: "Research Data",
      date: "2026-08-03"
    },
    {
      id: "doc_10_nrf",
      name: "National_Response_Framework.pdf",
      size: "5.1 MB",
      type: "Federal Framework",
      date: "2026-08-03"
    },
    {
      id: "doc_11_grants_api",
      name: "Grants_gov_API_SEARCH2.pdf",
      size: "200 KB",
      type: "API Documentation",
      date: "2026-08-03"
    },
    {
      id: "doc_12_tiger_line",
      name: "tl_2019_18_sldl.shp.iso.xml",
      size: "500 KB",
      type: "GIS Metadata",
      date: "2026-08-03"
    },
    {
      id: "doc_13_arcgis_rest",
      name: "ArcGIS_REST_Services_Directory.pdf",
      size: "100 KB",
      type: "API Documentation",
      date: "2026-08-03"
    }
  ...
  app.get("/api/pdf-search", (req, res) => {
    ...
    const results = [
      ...
      {
        pdfId: "doc_06_in_lidar",
        page: 1,
        snippet: "...Indiana's Statewide Lidar data is produced at 1.5-meter average post spacing... Area 3 (2013) Indiana western counties: ... Posey... DOI: https://doi.org/10.5069/G9959FHZ...",
        relevance: 0.88
      },
      {
        pdfId: "doc_07_fema_links",
        page: 1,
        snippet: "...References to federal agencies: FEMA Flood Maps (https://www.fema.gov/flood-maps), GSA Schedules, DHS Open Data, Grants.gov and 21st Century IDEA Act (https://digital.gov/resources/21st-century-integrated-digital-experience-act/)...",
        relevance: 0.85
      },
      {
        pdfId: "doc_08_nfip_toolkit",
        page: 2,
        snippet: "...As of 2025, the NFIP is the nation’s largest single-line insurance program, protecting nearly 4.7 million policyholders from flood loss...",
        relevance: 0.84
      },
      {
        pdfId: "doc_09_noaa_paleo",
        page: 1,
        snippet: "...NOAA/WDS Paleoclimatology - Goose and Grassy Pond, Ohio River Sediment and Geochemical Data during the last 2000 Years... Late Holocene flood frequencies on the lower Ohio River were investigated...",
        relevance: 0.83
      },
      {
        pdfId: "doc_10_nrf",
        page: 2,
        snippet: "...The National Response Framework (NRF) provides foundational emergency management doctrine for how the Nation responds to all types of incidents...",
        relevance: 0.82
      },
      {
        pdfId: "doc_11_grants_api",
        page: 1,
        snippet: "...The endpoint allows you to search for opportunities based on specific search parameters. Authentication and authorization is not required for search2...",
        relevance: 0.81
      },
      {
        pdfId: "doc_12_tiger_line",
        page: 1,
        snippet: "...TIGER/Line Shapefile, 2019, state, Indiana, Current State Legislative District (SLD) Lower Chamber State-based...",
        relevance: 0.80
      },
      {
        pdfId: "doc_13_arcgis_rest",
        page: 1,
        snippet: "...ArcGIS REST Services Directory... bag_bathymetry (ImageServer)... bathy_gap_analysis (MapServer)...",
        relevance: 0.79
      }
